sap.ui.define(["jquery.sap.global", "sap/ui/base/Object", "sap/ui/core/format/NumberFormat", "sap/ui/core/format/DateFormat", "sap/m/Select", "sap/m/MessageBox", "sap/m/MessageToast", "sap/m/Table",
	...
	"sap/suite/ui/generic/template/lib/testableHelper","sap/ui/table/TreeTable","sap/ui/model/json/JSONModel","sap/ui/core/mvc/ViewType", "sap/suite/ui/generic/template/js/AnnotationHelper", "sap/suite/ui/generic/template/lib/modelHelper"
], function(jQuery, BaseObject, NumberFormat, DateFormat, Select, MessageBox, MessageToast, Table, Filter, Sorter,
	SmartFilterBar, Time, testableHelper, TreeTable, JSONModel, ViewType, AnnotationHelper, modelHelper) {
			...
			if (isValidEntitySet){
				...
				for (var i = 0; i < aContexts.length; i++) {
					...
					if (!oEntity[bActionName]) {
						...
						var oHeaderInfoValue = oEntityType["com.sap.vocabularies.UI.v1.HeaderInfo"].Title.Value;
