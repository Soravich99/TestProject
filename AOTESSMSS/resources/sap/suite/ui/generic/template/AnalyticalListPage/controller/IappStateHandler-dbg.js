	...
	function getMethods(oState, oController, oNavigationHandler) {
		...
		function addDisplayCurrency(oSelectionVariant, oAppData) {
			...
			for (var item = 0;item < mandatoryFilterItems.length; item++) {
				if ((mandatoryFilterItems[item].getName().indexOf("$Parameter.P_DisplayCurrency") !== -1) && !(oSelectionVariant.getParameter("$Parameter.P_DisplayCurrency")) && !(oSelectionVariant.getParameter("P_DisplayCurrency"))){
					...
					} else if (oAppData.oDefaultedSelectionVariant.getSelectOption("DisplayCurrency") && oAppData.oDefaultedSelectionVariant.getSelectOption("DisplayCurrency")[0].Low) {
