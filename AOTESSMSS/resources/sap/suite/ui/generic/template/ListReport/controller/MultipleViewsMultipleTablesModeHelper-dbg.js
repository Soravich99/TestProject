		...
		function getMethods(oQuickVariantSelectionX, oState, oController, oTemplateUtils, fnSetInitialKey, mItemData) {
			...
			function fnSetTablesToDirtyByEntitySet(sEntitySet, bDirty) {
				...
				for (var i in mItemData) {
						oItem = mItemData[i];
//if sEntitySet is undefined, all tabs will be refreshed. If the sEntitySet is given only the tabs of this entity set will be refreshed 
					if (oItem.implementingControl.getProperty("entitySet") === sEntitySet || sEntitySet === undefined) {
