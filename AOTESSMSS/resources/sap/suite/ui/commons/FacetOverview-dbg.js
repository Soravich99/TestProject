...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/ui/core/IconPool', 'sap/ui/Device', 'sap/m/Label', 'sap/ui/core/ResizeHandler' ],
	function(jQuery, library, Control, IconPool, Device, Label, ResizeHandler) {
	"use strict";
	...
	FacetOverview.prototype._handleTitleResize = function() {
		...
		if (this._iTitleWidth != iTitleWidth) {
			var iTitleTextMaxWidth = iTitleWidth - jQuery.sap.byId(this.getId() + "-qty").outerWidth() - 15;// width of the icon is always stable
