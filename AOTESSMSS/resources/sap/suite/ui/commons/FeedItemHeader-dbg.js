...
sap.ui.define([ 'jquery.sap.global', 'sap/m/ListItemBase', './library', 'sap/ui/core/HTML' ],
	function(jQuery, ListItemBase, library, HTML) {
	"use strict";
	...
	FeedItemHeader.prototype.setImage = function(sImageUri) {
		if (sImageUri) {
			...
			if (validUrl) {
				...
				jQuery.sap.log.error("Invalid Url:'" + sImageUri + "'. Property 'image' of FeedItemHeader not set");
			}
		}
	};
	...
	FeedItemHeader.prototype.setLink = function(sLinkUri) {
		if (sLinkUri) {
			...
			if (validUrl) {
				...
				jQuery.sap.log.error("Invalid Url:'" + sLinkUri + "'. Property 'link' of FeedItemHeader not set");
			}
		}
	};
