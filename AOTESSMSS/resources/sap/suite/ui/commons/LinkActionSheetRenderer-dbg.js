...
sap.ui.define([ 'jquery.sap.global', 'sap/m/ActionSheetRenderer', 'sap/ui/core/Renderer', 'sap/m/Dialog' ], function(jQuery, ActionSheetRenderer, Renderer, Dialog) {
	"use strict";
	...
	LinkActionSheetRenderer.render = function(oRm, oControl) {
		...
		if ((jQuery.device.is.iphone || (Dialog._bOneDesign && jQuery.device.is.phone)) && oControl.getShowCancelButton()) {
