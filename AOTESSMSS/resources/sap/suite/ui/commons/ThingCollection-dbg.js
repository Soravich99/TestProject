...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/ui/core/Control', 'sap/ui/commons/Link', 'sap/ui/commons/library' ],
	function(jQuery, library, Control, Link, CommonsLibrary) {
	"use strict";
	...
	ThingCollection.prototype.onAfterRendering = function() {
		...
		jQuery.sap.byId(this.getId() + "-nav-prev").bind("click", function() {
			that.shiftPrev();
		});
		jQuery.sap.byId(this.getId() + "-nav-next").bind("click", function() {
			that.shiftNext();
		});
