...
sap.ui.define([ 'jquery.sap.global', './library', 'sap/m/library', 'sap/ui/comp/library', 'sap/ui/core/Control', 'sap/m/ComboBox', 'sap/m/Popover', 'sap/m/Link', 'sap/m/StandardListItem', 'sap/ui/core/delegate/ItemNavigation', 'sap/m/Button',
				...
				'sap/m/Label', 'sap/m/List', 'sap/m/ScrollContainer', 'sap/m/HBox', 'sap/m/VBox', 'sap/ui/comp/variants/VariantManagement', 'sap/m/GroupHeaderListItem', 'sap/ui/core/Item' ],
	function(jQuery, library, MobileLibrary, SmartLibrary, Control, ComboBox, Popover, Link, StandardListItem, ItemNavigation, Button, SelectDialog, Filter, FilterOperator, Element, Text, Bar, Sorter,
			 Device, Label, List, ScrollContainer, HBox, VBox, VariantManagement, GroupHeaderListItem, Item) {
	"use strict";
