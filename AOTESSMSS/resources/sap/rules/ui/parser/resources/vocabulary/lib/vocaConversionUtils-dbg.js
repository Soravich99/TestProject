jQuery.sap.declare("sap.rules.ui.parser.resources.vocabulary.lib.vocaConversionUtils");

// DUMMY FILE - SHOULD NOT CONTAIN CONTENT
// CLIENT DON'T NEED IT
// USED FOR COMPATABILITY WITH BACKEND CODE
sap.rules.ui.parser.resources.vocabulary.lib.vocaConversionUtils
    = sap.rules.ui.parser.resources.vocabulary.lib.vocaConversionUtils || {};
sap.rules.ui.parser.resources.vocabulary.lib.vocaConversionUtils.getVocaConversionUtils =
    function() {
