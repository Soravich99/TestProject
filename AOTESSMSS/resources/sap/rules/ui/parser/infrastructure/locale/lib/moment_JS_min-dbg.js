jQuery.sap.declare("sap.rules.ui.parser.infrastructure.locale.lib.moment_JS_min");
...
/**************************************************************************************************************************************** 
	...
	This file was manually converted from js (as it is taken from momentjs.com) to xsjslib.
	Therefore if you want to replace it with other version taken from the momentjs.com, DO NOT forget to adapt it accordingly !!!
	Just run dif and see what was changed during the manual conversion to xsjslib.
	
****************************************************************************************************************************************/


sap.rules.ui.parser.infrastructure.locale.lib.moment_JS_min = sap.rules.ui.parser.infrastructure.locale.lib.moment_JS_min|| {}; 
sap.rules.ui.parser.infrastructure.locale.lib.moment_JS_min.lib = (function() {
