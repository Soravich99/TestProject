jQuery.sap.declare("sap.rules.ui.parser.businessLanguage.lib.antlr3_all_min");

sap.rules.ui.parser.businessLanguage.lib.antlr3_all_min = sap.rules.ui.parser.businessLanguage.lib.antlr3_all_min|| {}; 
sap.rules.ui.parser.businessLanguage.lib.antlr3_all_min.lib = (function() {
	try {
		...
		org.antlr.lang = org.antlr.lang || {
			...
			extend: function(D, E, C) {
				...
				if (C !== null) {
					...
					org.antlr.lang.a_IEEnumFix(D.prototype, C);
				}
			},
			augmentObject: function(E, D) {
				...
				if (B && B !== true) {
					...
					org.antlr.lang.a_IEEnumFix(E, D);
				}
			},
			augmentProto: function(D, C) {
				...
				var B;
				for (B = 2; B < arguments.length; B = B + 1) {
					A.push(arguments[B]);
				}
		...
		if (org.antlr.runtime === undefined) {
			org.antlr.runtime = {};
		}
		...
		org.antlr.lang.extend(org.antlr.runtime.NoViableAltException, org.antlr.runtime.RecognitionException, {
			toString: function() {
				if (this.grammarDecisionDescription === undefined) {
					this.grammarDecisionDescription = null;
				}
		...
		org.antlr.runtime.BitSet.prototype = {
			...
			equals: function(A) {
				...
				var B = A,
					C, D = Math.min(this.bits.length, B.bits.length);
				for (C = 0; C < D; C++) {
			...
			toString: function() {
				if (arguments.length === 0) {
					...
					if (org.antlr.lang.isString(arguments[ZERO])) {
						if (!org.antlr.lang.isValue(arguments[ONE])) {
							return this.toString1(null);
						} else {
							return this.toString2(arguments[ZERO], arguments[ONE]);
						}
					} else {
						return this.toString1(arguments[ZERO]);
					}
				}
			},
		...
		org.antlr.runtime.CommonToken = function() {
			...
			this.index = -1;
			if (arguments.length === 1) {
				if (org.antlr.lang.isNumber(arguments[ZERO])) {
					this.type = arguments[ZERO];
				} else {
					A = arguments[ZERO];
					this.text = A.getText();
					this.type = A.getType();
				...
				if (arguments.length === 2) {
					this.type = arguments[ZERO];
					this.text = arguments[ONE];
					this.channel = 0;
				} else {
					if (arguments.length === 5) {
						this.input = arguments[ZERO];
						this.type = arguments[ONE];
						this.channel = arguments[TWO];
						this.start = arguments[THREE];
						this.stop = arguments[FOUR];
					}
				}
			}
		};
		...
		if (org.antlr.runtime.tree === undefined) {
		...
		org.antlr.runtime.tree.BaseTreeAdaptor.prototype = {
			...
			create: function(C, B) {
				var D, A;
				if (arguments.length === 2) {
					if (org.antlr.lang.isString(arguments[ONE])) {
						D = arguments[ONE];
		...
		org.antlr.lang.extend(org.antlr.runtime.tree.CommonTreeAdaptor, org.antlr.runtime.tree.BaseTreeAdaptor, {
			...
			createToken: function(A) {
				if (arguments.length === 2) {
					return new org.antlr.runtime.CommonToken(arguments[ZERO], arguments[ONE]);
				} else {
					return new org.antlr.runtime.CommonToken(arguments[ZERO]);
				}
			},
		...
		f = function() {
			...
			org.antlr.lang.extend(A, org.antlr.runtime.CommonTokenStream, {
				...
				rollback: function() {
					...
					if (D) {
						this.programs[B] = D.slice(A.MIN_TOKEN_INDEX, this.instructionIndex);
					}
				},
		...
		org.antlr.runtime.BaseRecognizer.prototype = {
			...
			mismatchIsMissingToken: function(C, A) {
				...
				if (A.member(org.antlr.runtime.Token.EOR_TOKEN_TYPE)) {
					if (this.state.a_fsp >= 0) {
						A.remove(org.antlr.runtime.Token.EOR_TOKEN_TYPE);
					}
					var B = this.computeContextSensitiveRuleFOLLOW();
					if (this.viableTokensFollowingThisRule === undefined) {
						this.viableTokensFollowingThisRule = null;
					}
			...
			getErrorMessage: function(E, D) {
				...
				if (E instanceof org.antlr.runtime.UnwantedTokenException) {
					...
					F = "extraneous input " + this.getTokenErrorDisplay(B.getUnexpectedToken()) + " expecting " + C;
				} else {
					if (E instanceof org.antlr.runtime.MissingTokenException) {
						...
						if (E instanceof org.antlr.runtime.MismatchedTokenException) {
							...
							F = "mismatched input " + this.getTokenErrorDisplay(E.token) + " expecting " + C;
						} else {
			...
			combineFollows: function(C) {
				var E = this.state.a_fsp,
					B, A, D = new org.antlr.runtime.BitSet();
				for (B = E; B >= 0; B--) {
			...
			recoverFromMismatchedSet: function(B, C, A) {
				if (this.mismatchIsMissingToken(B, A)) {
					this.reportError(C);
					return this.getMissingSymbol(B, C, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, A);
				}
				throw C;
			},
			...
			pushFollow: function(A) {
				if ((this.state.a_fsp + 1) >= this.state.following.length) {
					var C = [];
					var B;
				...
				this.state.a_fsp++;
				this.state.following[this.state.a_fsp] = A;
			},
			...
			memoize: function(C, D, B) {
				var A = this.state.failed ? org.antlr.runtime.BaseRecognizer.MEMO_RULE_FAILED : C.index() - 1;
				...
				if (D >= this.state.ruleMemo.length) {
					throw new Error("!!!!!!!!! memo size is " + this.state.ruleMemo.length + ", but rule index is " + D);
				}
		...
		org.antlr.runtime.BaseRecognizer.prototype.constructor = org.antlr.runtime.BaseRecognizer;
		...
		org.antlr.lang.extend(org.antlr.runtime.Lexer, org.antlr.runtime.BaseRecognizer, {
			...
			emit: function() {
				if (arguments.length === 0) {
					...
					this.state.token = arguments[ZERO];
					return null;
				}
			},
			match: function(C) {
				...
				if (org.antlr.lang.isString(C)) {
					while (B < C.length) {
						if (this.input.LA(1) !== C.charAt(B)) {
							...
							A = new org.antlr.runtime.MismatchedTokenException(C.charAt(B), this.input);
							this.recover(A);
							throw A;
						}
						B++;
			...
			matchRange: function(B, A) {
				if (this.input.LA(1) < B || this.input.LA(1) > A) {
					...
					var mre = new org.antlr.runtime.MismatchedRangeException(B, A, this.input);
					this.recover(mre);
					throw mre;
				}
				this.input.consume();
			...
			traceIn: function(C, B) {
				var A = String.fromCharCode(this.input.LT(1)) + " line=" + this.getLine() + ":" + this.getCharPositionInLine();
		...
		org.antlr.lang.extend(org.antlr.runtime.Parser, org.antlr.runtime.BaseRecognizer, {
			...
			getMissingSymbol: function(C, G, E, A) {
				//IDP - start
				if (this.getTokenNames()[E] === undefined) {
					this.getTokenNames()[E] = null;
				}
				//IDP - end
			...
			traceIn: function(B, A) {
				org.antlr.runtime.Parser.superclass.traceIn.call(this, B, A, this.input.LT(1));
			},
			traceOut: function(B, A) {
				org.antlr.runtime.Parser.superclass.traceOut.call(this, B, A, this.input.LT(1));
			}
		});
		...
		org.antlr.runtime.DFA.prototype = {
			...
			noViableAlt: function(C, A) {
				if (this.recognizer.hasOwnProperty("bingoNoViableAlt")) {
					this.recognizer.bingoNoViableAlt(this.decisionNumber);
					return;
				}
				...
				var B = new org.antlr.runtime.NoViableAltException(this.getDescription(), this.decisionNumber, C, A);
				this.error(B);
				throw B;
			},
			error: function(A) {},
		...
		org.antlr.runtime.tree.TreeParser = function(A) {
			org.antlr.runtime.tree.TreeParser.superclass.constructor.call(this, arguments[ONE]);
		...
		f = function() {
			...
			org.antlr.lang.extend(A, org.antlr.runtime.BaseRecognizer, {
				...
				getMissingSymbol: function(D, F, E, B) {
					...
					return new org.antlr.runtime.tree.CommonTree(new org.antlr.runtime.CommonToken(E, C));
				},
				matchAny: function(E) {
					this.state.errorRecovery = false;
					this.state.failed = false;
				...
				getErrorHeader: function(B) {
					return this.getGrammarFileName() + ": node from " + (B.approximateLineInfo ? "after " : "") + "line " + B.line + ":" + B.charPositionInLine;
				},
				getErrorMessage: function(C, B) {
					...
					if (this instanceof A) {
						...
						if (!org.antlr.lang.isValue(C.token)) {
							C.token = new org.antlr.runtime.CommonToken(D.getType(C.node), D.getText(C.node));
						}
					}
