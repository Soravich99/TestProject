...
jQuery.sap.require("sap.collaboration.components.socialtimeline.validation.InputValidator");
jQuery.sap.require("sap.collaboration.components.socialtimeline.controls.TimelineItemEmbedded");
...
jQuery.sap.require("sap.collaboration.components.socialtimeline.filter.FilterType");
jQuery.sap.require("sap.collaboration.components.controls.ReplyPopover");
jQuery.sap.require("sap.collaboration.components.controls.SocialTextArea");
jQuery.sap.require("sap.collaboration.components.controls.FilterPopover");

jQuery.sap.require("sap.collaboration.components.utils.CommonUtil");
jQuery.sap.require("sap.collaboration.components.utils.DateUtil");
