	...
	StepwiseZoomStrategy.prototype._calTotalHorizon = function(nTimeSpanDelta, nNewTimeSpan) {
		...
		if (nTimeSpanDelta !== 0) {
			...
			if ( nTimeSpanDelta > 0 ){
				...
				nNewTotalHorizonStartTimeInMs = Format.abapTimestampToDate(oTotalHorizon.getStartTime()).getTime() - nTimeSpanDelta / 2;
				nNewTotalHorizonEndTimeInMs = Format.abapTimestampToDate(oTotalHorizon.getEndTime()).getTime() + nTimeSpanDelta / 2;
