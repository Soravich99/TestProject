...
sap.ui.define([], function () {
	'use strict';
	return {
		"analyticalConfigurationName": "APF Standard Demo",
		"applicationTitle": {
			"type": "label",
			"kind": "text",
			"key": "57FCA4E2C3D350DEE10000000A442AF5"
		},
		"steps": [
			{
				"type": "step",
			...
			},
			{
				...
				"title": {
					"type": "label",
					"kind": "text",
					"key": "15102377857028838103150312430278"
				},
				"navigationTargets": []
			},
			{
			...
			},
			{
				...
				"title": {
					"type": "label",
					"kind": "text",
					"key": "15102377963651508758254158996844"
				},
				"navigationTargets": []
			},
			{
			...
			},
			{
				"type": "step",
				"description": "Revenue by Country and Month",
				"request": "request-for-Step-26",
				"binding": "binding-for-Step-26",
				"id": "Step-26",
				"title": {
					"type": "label",
					"kind": "text",
			...
			{
				"type": "step",
				"description": "Discount by Customer",
				"request": "request-for-Step-29",
				"binding": "binding-for-Step-29",
				"id": "Step-29",
				"title": {
					"type": "label",
					"kind": "text",
					"key": "15102370883951657475286461234693"
				},
				"navigationTargets": [],
				"thumbnail": {
					"type": "thumbnail",
		...
		"requests": [
			...
			{
				"type": "request",
				"id": "FilterResolution-request-for-FacetFilter-4",
				"service": "/tmp/demokit/demokit.xsodata",
				"entitySet": "CustomerGroup",
				"selectProperties": [
					"CustomerGroup",
					"CustomerGroupName"
				]
			...
			{
				"type": "request",
				"id": "FilterResolution-request-for-FacetFilter-5",
				"service": "/tmp/demokit/demokit.xsodata",
				"entitySet": "RevenueQuery",
				"selectProperties": [
					"Customer",
		...
		"bindings": [
				...
				"representations": [
					{
						...
						"thumbnail": {
							...
							"leftUpper": {
								"type": "label",
								"kind": "text",
								"key": "15102377426421018326751208039995"
							}
						}
					}
				]
			...
			{
				"type": "binding",
				"id": "binding-for-Step-29",
				"stepDescription": "Discount by Customer",
				"requiredFilters": [
					"Customer"
				],
				"requiredFilterOptions": {
				...
				"parameters": [
					{
						...
						"value": "57FCA36EC3D350DEE10000000A442AF4"
					}
				],
				"title": {
					"key": "15181818661221038491819157748774",
					"type": "label",
					"kind": "text"
				}
			}
		...
		"facetFilters": [
			...
			},
			{
				...
				"label": {
					"type": "label",
					"kind": "text",
					"key": "57FCA4EBC3D350DEE10000000A442AF5"
				},
				"invisible": true,
			...
			},
			{
				...
				"valueHelpRequest": "FilterResolution-request-for-FacetFilter-3",
				"hasAutomaticSelection": "false",
				"useSameRequestForValueHelpAndFilterResolution": "true"
			},
			{
				"type": "facetFilter",
				...
				"label": {
					"type": "label",
					"kind": "text",
					"key": "57FCA4F5C3D350DEE10000000A442AF5"
				},
				"invisible": false,
				"filterResolutionRequest": "FilterResolution-request-for-FacetFilter-4",
				"valueHelpRequest": "FilterResolution-request-for-FacetFilter-4",
				"hasAutomaticSelection": "false",
				"useSameRequestForValueHelpAndFilterResolution": "true"
			},
			{
				...
				"label": {
					"type": "label",
					"kind": "text",
					"key": "57FCA4FBC3D350DEE10000000A442AF5"
				},
				"invisible": false,
				"filterResolutionRequest": "FilterResolution-request-for-FacetFilter-5",
				"valueHelpRequest": "FilterResolution-request-for-FacetFilter-5",
				"hasAutomaticSelection": "false",
				"useSameRequestForValueHelpAndFilterResolution": "true"
			}
		],
		"configHeader": {
			...
			"SemanticObject": "FioriApplication",
			"AnalyticalConfiguration": "57FCA36EC3D350DEE10000000A442AF4",
			"AnalyticalConfigurationName": "APF Standard Demo",
			"UI5Version": "1.52.4",
