...
(function() {
	"use strict";
	var oCoreApi, oUiApi, oActiveStep, bRepresentationChanged = false, isTreeTableWindowResized = false;
	...
	function _setSelectionPropertyCountText(oController, oChartContainerToolbar) {
		...
		var selectedDimension = oController.getCurrentRepresentation().getSelectionFilterLabel();
