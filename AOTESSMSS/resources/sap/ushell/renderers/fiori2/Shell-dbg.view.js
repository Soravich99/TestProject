...
sap.ui.define([
    ...
    sap.ui.jsview("sap.ushell.renderers.fiori2.Shell", {
                ...
                onsaptabprevious: function (oEvent) {
                    ...
                    case "LeftCenter":
                        ...
                        if (oRecentItemsList.length > 0) {
                            ...
                            if(oConfig.enableRecentActivity && sap.ui.getCore().byId("mainShell").getModel().getProperty("/enableTrackingActivity")) {
            ...
            if (oConfig.enablePersonalization !== false) {
                ...
                var press = function () {
                    ...
                    if (oUrlParser) {
                        ...
                        oHash.appSpecificRoute = "&/appFinder/catalog";
                    ...
                    if (this.data("isShellHeader")) {
                        ...
                        var starsWithShellHash = new RegExp("^" + sAppFinderHash);
        ...
        loadUserImage: function() {
            ...
            // user image is disabled by default; can be enabled via bootstrap configuration
            // see internal BCP 1880242616
            function isUserImageEnabled(oShellView) {
                var oViewData = oShellView.getViewData() || {},
                    oConfig = oViewData.config || {};

                return oConfig.enableUserImage;
            }

            if (isUserImageEnabled(this)) {
