...
sap.ui.define([
    ...
    CatalogEntryContainer.prototype.addNewItem = function (elementToDisplay, sName) {
        ...
        if (sName === "customTilesContainer") {
            // Patch for customer incident 421255 - DynamicTile sends requests from AppFinder
            // The issue is handled by setting configurationUi to true as done by flp designer
            // Currently - UI5 do not support API for setting a tile to preview mode
            // This code should be updated once the appropriate feature is delivered by UI5
            if (elementToDisplaySrc !== undefined ) {
                if (elementToDisplaySrc.Chip !== undefined && elementToDisplaySrc.Chip.getContract !== undefined) {
                    contract = elementToDisplaySrc.Chip.getContract("configurationUi");
                } else if (elementToDisplaySrc.getContract !== undefined) {
                    contract = elementToDisplaySrc.getContract("configurationUi");
                }
