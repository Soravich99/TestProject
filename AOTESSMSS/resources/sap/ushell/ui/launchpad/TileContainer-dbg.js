 ...
 */
    ...
    TileContainer.prototype.setShowGroupHeader = function (bVisible, bFirstGroup) {
        this.setProperty("showGroupHeader", bVisible, true);  // suppress rerendering
        if (bFirstGroup) {
            this.$().find(".sapUshellTileContainerHeader").toggleClass("sapUshellFirstGroupHeaderHidden",!bVisible);   
        } else {
