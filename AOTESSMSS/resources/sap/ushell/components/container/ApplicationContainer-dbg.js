...
//          UI5: "UI5", // SAP UI development toolkit for HTML5
    ...
    function appendSapShellParam(sUrl, sApplicationType) {
        ...
        var sVersion,
            getVersion = function () {
                ...
                try { // in the sandbox 10.121.3.62 scenario, sap.ui.getVersionInfo() triggers an exception
     ...
     * @private
     */
    function adjustNwbcUrl(sUrl, sUrlApplicationType, sTargetNavigationMode) {
        var sTheme,
    ...
    function render(oRenderManager, oContainer, sApplicationType, sUrl, sAdditionalInformation) {
        ...
        if (sap.ushell.utils.isApplicationTypeNWBCRelated(sApplicationType)) {
            ...
            sUrl = sap.ushell.components.container.ApplicationContainer.prototype._adjustNwbcUrl(sUrl, sApplicationType, sTargetNavigationMode);
