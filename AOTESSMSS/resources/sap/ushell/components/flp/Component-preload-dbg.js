    ...
    */
    ...
    ActionMode.prototype.toggleActionMode = function (oModel, sSource, dashboardGroups) {
        ...
        if (currentGroup) {
            ...
            var groupScrolled = document.getElementById("sapUshellDashboardPage-cont").scrollTop - domRef.offsetTop;
            this.viewPoint = {
    ...
    return UIComponent.extend("sap.ushell.components.flp.Component", {
        ...
        _setConfigurationToModel : function (oConfig) {
            ...
            if (oConfig) {
                ...
                if (oConfig.appFinderDisplayMode !== undefined) {
                    oModel.setProperty("/appFinderDisplayMode", oConfig.appFinderDisplayMode);
                }
...
sap.ui.define(['sap/ushell/ui/launchpad/AccessibilityCustomData'],
	...
	"sap/ushell/components/flp/launchpad/DashboardLoadingManager.js":function(){// Copyright (c) 2009-2017 SAP SE, All Rights Reserved
...
//            this.oDashboardManager.oModel.setProperty("/groups", aGroups);
        ...
        _addTileToRefreshArray: function (sChannelId, sEventId, oTileControl) {
            this.aRefreshTiles.push(oTileControl);
        },
            ...
            for (var iVisibleTileIndex = 0; iVisibleTileIndex < this.currentVisibleTiles.length; iVisibleTileIndex++) {
                ...
                if (tileObject) {
                    for (var iRefreshTilesIndex = 0; iRefreshTilesIndex < this.aRefreshTiles.length; iRefreshTilesIndex++) {
                        if (oTile.content[0].oParent === this.aRefreshTiles[iRefreshTilesIndex]) {
...
sap.ui.define(['sap/ushell/services/Message', 'sap/ui/base/EventProvider', 'sap/ushell/ui/launchpad/TileState', "sap/ushell/components/flp/launchpad/PagingManager", "sap/ushell/components/flp/launchpad/DashboardLoadingManager"],
    ...
    var DashboardManager = EventProvider.extend("sap.ushell.components.flp.launchpad.DashboardManager", {
        ...
        constructor: function (sId, mSettings) {
            ...
            sap.ui.getCore().attachThemeChanged(sap.ushell.utils.handleTilesVisibility);
        ...
        destroy: function () {
            ...
            sap.ui.getCore().detachThemeChanged(sap.ushell.utils.handleTilesVisibility);
        ...
        handleSearchModelChanged: function () {
            ...
            if (bSearchMode || bTagMode || this.resetPage) {
                ...
                catalogs.forEach(function (myCatalog){
                    myCatalog.getBinding("customTilesContainer").filter(aFilters);
                    myCatalog.getBinding("appBoxesContainer").filter(aFilters);
...
sap.ui.define(["sap/ui/model/odata/ODataUtils"], function (ODataUtils) {
	"use strict";
        ...
        addRemoveTileFromGroup: function (sItemModelPath, oPopoverModel, bToAdd) {
            ...
            if (bToAdd) {
                ...
                oAddPromise.done(function (data) {
                    var catalogTilePath = thatView.getViewData().sourceContext,
...
sap.ui.define(function() {
    ...
    sap.ui.jsview("sap.ushell.components.flp.launchpad.appfinder.GroupListPopover", {
        ...
        _createHeadBarForNewGroup: function () {
            ...
            var oHeadBar = new sap.m.Bar("oHeadBar", {
...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.components.flp.launchpad.dashboard.DashboardContent", {
        ...
        dashboardTilePress: function (oEvent) {
            ...
            if (oTileControl && document.activeElement.tagName !== "INPUT" && bSlideTile !== true) {
            ...
            sap.ui.getCore().getEventBus().publish("launchpad", "dashboardTileClick", oTileControl);
        },
...
//                    this.removeLinksFromUnselectedGroups();
        ...
        _updateFirstGroupHeaderVisibility: function (bIsEditMode, bEnableAnchorBar) {
            ...
            // The GroupContainer might not contain hidden groups in tab mode
            this.oModel.getProperty("/groups").forEach(function(oGroup) {
            ...
            if (iFirstVisible !== undefined) {
                var oFirstGroupDomRef,
                    bFirstGroup = false,
                    sGroupsMode = this.oModel.getProperty("/homePageGroupDisplay"),
                    bVisible =  bIsEditMode || (iVisibleGroups === 1 && bEnableAnchorBar) || (sGroupsMode === "tabs" && iVisibleGroups === 1);
                if (iVisibleGroups > 1 || (sGroupsMode === "tabs" && iVisibleGroups > 1)) {
                    oFirstGroupDomRef = aGroups[iFirstVisible].getDomRef();
                    oFirstGroupDomRef.getElementsByClassName("sapUshellTileContainerHeader")[0].classList.add("sapUiPseudoInvisibleText");
                    bFirstGroup = true;
                }
