        ...
        this.registerCustomResolver({ name : "StandaloneLocalResolver",
            ...
            resolveHashFragment : function (sHashFragment) {
                ...
                if (hardCoded[sHashFragment]) {
                    ...
                    // Configuring an app via url parameters is restricted to 10.121.3.62 for security reasons,
                    // unless explicitly enabled by config
                    if ((window.location.hostname === "10.121.3.62") ||
                ...
                jQuery.sap.log.info("NavTargetResolution: As URL:  http://10.121.3.62:8080/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html?sap-ushell-test-local1-url=" + encodeURIComponent((res && res.url) || "") + "&sap-ushell-test-local1-additionalInformation=" + encodeURIComponent((res && res.additionalInfo) || "") + "#Test-local1");
