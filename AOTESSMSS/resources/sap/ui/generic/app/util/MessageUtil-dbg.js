	...
	function (ValueState, Filter, FilterOperator, MessageToast, MessageBox) {
		...
		function handleTransientMessages(vMessageDialogData, sActionLabel) {
			...
			if (aTransientMessages.length === 0) {
				...
				oMap.Error && createList(oList, oMap.Error, oLibraryResourceBundle.getText("ERROR_TITLE"));
				oMap.Warning && createList(oList, oMap.Warning, oLibraryResourceBundle.getText("WARNING_TITLE"));
				oMap.Success && createList(oList, oMap.Success, oLibraryResourceBundle.getText("SUCCESS_TITLE"));
				oMap.Information && createList(oList, oMap.Information, oLibraryResourceBundle.getText("INFORMATION_TITLE"));
