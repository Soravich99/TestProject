	...
	function(jQuery, Plugin) {
		...
		Debugging.prototype._populateRebootUrls = function() { // checks whether known URLs where UI5 could be booted from are reachable
			...
			this._mRebootUrls = {
				...
				"http://10.121.3.62:8080/testsuite/resources/sap-ui-core.js": "10.121.3.62 (port 8080), /testsuite ('grunt serve' URL)",
				"http://10.121.3.62:8080/sapui5/resources/sap-ui-core.js": "10.121.3.62 (port 8080), /sapui5 (maven URL)"
			};
