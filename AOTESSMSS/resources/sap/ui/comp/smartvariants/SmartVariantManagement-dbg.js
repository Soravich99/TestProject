...
sap.ui.define([
	'jquery.sap.global', 'sap/ui/comp/library', './PersonalizableInfo', 'sap/ui/comp/variants/VariantItem', 'sap/ui/comp/variants/VariantManagement', 'sap/ui/fl/registry/Settings', 'sap/ui/fl/Change', 'sap/ui/fl/Persistence', 'sap/ui/fl/Utils', 'sap/ui/fl/transport/TransportSelection'
], function(jQuery, library, PersonalizableInfo, VariantItem, VariantManagement, Settings, Change, Persistence, FlexUtils, TransportSelection) {
	"use strict";
...
// }
	...
	SmartVariantManagement.prototype.initialise = function(fCallback, oPersoControl) {
		var oCurrentControlWrapper = null, that = this;
		...
		try {
			...
			if (this._oControlPromise && this._oPersoControl && oCurrentControlWrapper) {
				...
				Promise.all([
					this._oControlPromise, Settings.getInstance()
				]).then(function(aVariants) {

					that._dataReceived(aVariants[0], aVariants[1], oCurrentControlWrapper);
	...
	SmartVariantManagement.prototype._errorHandling = function(sErrorText, fCallback, oPersoControl) {
		...
		if (oPersoControl && oPersoControl.variantsInitialized) {
