...
sap.ui.define([
	'jquery.sap.global', 'sap/m/MessageBox', 'sap/ui/comp/filterbar/FilterBar', 'sap/ui/comp/filterbar/FilterGroupItem', 'sap/ui/comp/filterbar/FilterItem', 'sap/ui/comp/library', './AdditionalConfigurationHelper', './ControlConfiguration', './FilterProvider', './GroupConfiguration', 'sap/ui/comp/util/FormatUtil', 'sap/ui/comp/smartvariants/PersonalizableInfo', 'sap/ui/comp/smartvariants/SmartVariantManagement', 'sap/ui/comp/odata/ODataModelUtil'
], function(jQuery, MessageBox, FilterBar, FilterGroupItem, FilterItem, library, AdditionalConfigurationHelper, ControlConfiguration, FilterProvider, GroupConfiguration, FormatUtil, PersonalizableInfo, SmartVariantManagement, ODataModelUtil) {
	"use strict";
		...
		if (!this.bIsInitialised) {
			...
			if (this._oFilterProvider) {
				...
				if (this._aFilterBarViewMetadata) {
					...
					this.registerFetchData(this.getFilterDataAsStringForVariant.bind(this, true));
					this.registerApplyData(function(sJson) {
						this.setFilterDataAsStringFromVariant(sJson, true);
					}.bind(this));
	...
	SmartFilterBar.prototype.getFilterDataAsStringForVariant = function(bAllFilterData) {
	...
	SmartFilterBar.prototype.setFilterDataAsStringFromVariant = function(sJson, bReplace) {
		var oJson, aDateTimeOffsetFilterNames = this._oFilterProvider._aFilterBarDateTimeFieldNames;
