...
sap.ui.define([
	...
	ContentDeliveryService.prototype.load = function(parentNode, contentResource) {
		...
		return new Promise(function(resolve, reject) {
			var source = {
				url: contentResource.getSource(),
				veid: contentResource.getVeid(),
				httpHeaders: contentResource.getHttpHeaders(),
			...
			if (!source.url || !source.veid) {
				reject("url or veid not specified");
				return;
			}

			that.initUrl(source.url, source.httpHeaders).then(function() {
