...
sap.landvisz.libs.lvsvg.convertHtmltoCanvas=function(c,n){html2canvas(c,{allowTaint:true,useCORS:true,onrendered:function(a){n.show(1000);n.css({'background-image':"url("+a.toDataURL("image/png")+")",'background-size':"100% 100%"});}});}
