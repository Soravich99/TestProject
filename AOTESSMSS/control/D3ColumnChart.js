sap.ui.define([
	...
	return D3Chart.extend("sap.ui.demo.toolpageapp.control.D3ColumnChart", {
		...
		_updateSVG: function (iWidth) {
			...
			selContainer.select("rect:nth-child(6)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart6"));
			selContainer.select("rect:nth-child(7)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart7"));
			selContainer.select("rect:nth-child(8)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart8"));
			selContainer.select("rect:nth-child(9)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart9"));
			selContainer.select("rect:nth-child(10)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart10"));
			selContainer.select("rect:nth-child(11)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart11"));
			selContainer.select("rect:nth-child(12)").style("fill", sap.ui.core.theming.Parameters.get("sapUiChart1"));
