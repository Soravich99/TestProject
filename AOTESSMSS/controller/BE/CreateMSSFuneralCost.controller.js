sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.CreateMSSFuneralCost", {
...
//			jQuery.sap.syncStyleClass("sacUiSizeCompact", this.getView(), this._oDialog);
		...
		getValueamt: function(){
			var a1 = parseFloat(this.getView().byId("amt1").getValue().replace(/,/g,""));
			var a2 = parseFloat(this.getView().byId("amt2").getValue().replace(/,/g,""));
			var a3 = parseFloat(this.getView().byId("amt3").getValue().replace(/,/g,""));
			var a4 = parseFloat(this.getView().byId("amt4").getValue().replace(/,/g,""));
