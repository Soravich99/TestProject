sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.ChangeFund3", {
		...
		onSendPress: function(){
			...
			var url = 'http://webdeqapp.airportthai.co.th:8088/api/aot/v1/tblDocrunning/' + 'BE' + year + month + '/12';
...
//			var v5 = ",v5:"+this.getView().byId("v5").getValue();
			...
			var script = spernr+emepc;//+p1+p2+p3+p4+p5+v1+v2+v3+v4+v5;
