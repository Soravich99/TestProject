sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.TimeUniform", {
		...
		onInit: function () {
			...
			this.getView().byId("begda").setValue([d,m,y].join("/"));
			...
			this.getView().byId("endda").setValue([d,m,y].join("/"));
			...
			this.getView().byId("lastdate").setValue([d,m,y].join("/"));
			
			var TimeScholar;
			$.ajax({
	        	type: "GET",
	        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1//TimeScholar/Uniformx",
	        	async: false,
	        	success: function(data){
	        		TimeScholar = data;
			...
			this.getView().byId("effectdate").setValue([d,m,y].join("/"));
//			this.getView().setModel(membersModel);
		...
		onSavePressed: function () {
			...
			TimeScholar.TimeScholar.begda = this.onDateTosave2(this.getView().byId("begda").getValue());
			TimeScholar.TimeScholar.endda = this.onDateTosave(this.getView().byId("endda").getValue());
			...
			TimeScholar.TimeScholar.begda = this.onDateTosave(this.getView().byId("lastdate").getValue());
			TimeScholar.TimeScholar.endda = this.onDateTosave(this.getView().byId("lastdate").getValue());
			...
			TimeScholar.TimeScholar.begda = this.onDateTosave(this.getView().byId("effectdate").getValue());
			TimeScholar.TimeScholar.endda = this.onDateTosave(this.getView().byId("effectdate").getValue());
