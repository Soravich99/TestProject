sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.ApproveFuneralCost", {
		...
		onInit: function () {
			...
			oRouter.getRoute("BE/approveFuneralCost").attachPatternMatched(this._onObjectMatched, this);
...
//			}
		...
		onEditPressed: function () {
			...
			this.getView().byId("ELCLP").setEnabled(true);
			this.getView().byId("perItem").setEnabled(true);
