sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.ApproveChildrenAllowanceTypeO", {
...
//				}	
			...
			$.ajax({
	        	type: "GET",
	        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/PA9701/"+user,
	        	async: false,
	        	success: function(data){
	        		pa9701 = data;
			...
			for(var x = 0;x<pa9701.List.length;x++){
				if(pa9701.List[x].child_rep != null){
					...
					objps_rep = pa9701.List[x].objps_rep;
				...
				$.ajax({
		        	type: "GET",
		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/PA9701/s/"+user+"/"+objps_rep,
		        	async: false,
		        	success: function(data){
		        		pa9701x = data;
				...
				var value;
				var item_arr = decodeURIComponent(escape(window.atob(itemList))).split("|");
				...
				var oTablex = this.getView().byId("idTab01");
				var oItemx = new sap.m.ColumnListItem({
					cells : [ 	new sap.m.Text({text:pa9701x.PA9701.objps_for}),
								new sap.m.Text({text:pa9701x.PA9701.ename}),
								new sap.m.Text({text:this.onDatedisplay2(pa9701x.PA9701.fgbdt)}),
								new sap.m.Text({text:this.onChildage(pa9701x.PA9701.fgbdt)}),
								new sap.m.Text({text:this.onDatedisplay(pa9701x.PA9701.pa9701key.begda)}),
								new sap.m.Text({text:this.onDatedisplay(pa9701x.PA9701.pa9701key.endda)}),
								new sap.m.Text({text:pa9701x.PA9701.icnum}),
								new sap.m.Text({text:pa9701x.PA9701.elamt}),
