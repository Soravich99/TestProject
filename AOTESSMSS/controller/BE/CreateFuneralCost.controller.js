sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.CreateFuneralCost", {
		...
		onInit: function () {
			...
			for(var x = 0;x<pa9701.List.length;x++){
				...
				if(elclp != pa9701.List[x].elclp){
					...
					temp.List[x].text = pa9701.List[x].eltxt;
					temp.List[x].key = pa9701.List[x].elclp;
				}
