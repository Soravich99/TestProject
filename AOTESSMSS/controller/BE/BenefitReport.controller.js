sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.BE.BenefitReport", {
...
//	        });
		...
		onPressScholarship: function (evt) {
			this.getRouter().navTo("BE/scholarShipReport");
		},
		onPressDonate: function (evt) {
			this.getRouter().navTo("BE/donateReport");
		},
		onPressFund: function (evt) {
			this.getRouter().navTo("BE/fundReport");
		}
