sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.PA.Referee", {
		...
		onSearch: function(){
			...
			$.ajax({
	        	type: "GET",
	        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/PA0002/N/"+favor+"/"+fanam,
	        	async: false,
	        	success: function(data){
	        		pa0002 = data;
			...
			if(pa0002 != "X"){
				this.getView().byId("NUM01").setValue(pa0002.PA0002.pernr);
				var pa0001
				$.ajax({
		        	type: "GET",
		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/pa0001/"+pa0002.PA0002.pernr,
		        	async: false,
		        	success: function(data){
		        		pa0001 = data;
				...
				var org = pa0001.PA0001.orgeh.toString().padStart(8,'0');
				$.ajax({
		        	type: "GET",
		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1000/"+org,
		        	async: false,
		        	success: function(data){
		        		hrp1000 = data;
				...
				this.getView().byId("EFAML").setValue(hrp1000.HRP1000.stext);
		...
		onSavePressed: function () {
			...
			var efaml = this.getView().byId("EFAML").getValue();
			
			if(fanam.length == 0 || favor.length == 0 || telnr.length == 0){
				...
				var url = 'http://webdeqapp.airportthai.co.th:8088/api/aot/v1/tblDocrunning/' + 'PA' + year + month + '/12';
				...
				$.ajax({
		        	type: "GET",
		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/PA0021/"+pernr+"/91",
		        	async: false,
		        	success: function(data){
		        		pa0021 = data;
				...
				json = '{"docid":"'+docid+'","script":"'+json+'","stable":"pa0021"}';
