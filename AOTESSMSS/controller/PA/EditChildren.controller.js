sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.PA.EditChildren", {
...
//					this.getView().byId("age").setValue(ageyear);
		...
		onMasterPressed: function (oEvent) {
			...
			oRouter.getRoute("PA/editChildren").attachPatternMatched(this._onObjectMatched, this);
		},
