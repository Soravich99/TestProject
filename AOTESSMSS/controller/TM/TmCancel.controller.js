sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.TM.TmCancel", {
...
//				var field = fieldar[0];
//			    if(field.includes("cnType") == true){ cnType = pa2003_arr[i].split(":").pop(); }
//			    if(field.includes("cnDoc") == true){ cnDoc = pa2003_arr[i].split(":").pop(); }
//			    if(field.includes("cnDate") == true){ cnDate = pa2003_arr[i].split(":").pop(); }
//			    if(field.includes("cnReason") == true){ cnReason = pa2003_arr[i].split(":").pop(); }
//			    
//			}
			...
			var td = [d,m,y].join("/")
			this.getView().byId("cnDoc").setValue(docno);
			this.getView().byId("cnType").setValue(docHead.tblDocheader.header);
			this.getView().byId("cnDate").setValue(td);
			...
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("TM/tmCancel").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		onSendPressed: function (value){
			var docData;
			var docno = this.getView().byId("cnDoc").getValue();
