sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.TM.ApproveChangeTurn", {
		...
		onInit: function () {
			...
			var url = "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/tblDocdetail/"+docno+"/pa2006";
			$.ajax({
	        	type: "GET",
	        	url: url,
	        	async: false,
			...
			for (var i = 0; i < arrayLength; i++) {
			    ...
			    if(field.includes("timper1") == true){ timper1 = pa2003_arr[i].split(":").pop(); }
			    if(field.includes("timper2") == true){ timper2 = pa2003_arr[i].split(":").pop(); }
			    if(field.includes("timper3") == true){ timper3 = pa2003_arr[i].split(":").pop(); }
			    if(field.includes("geber1") == true){ geber1 = pa2003_arr[i].split(":").pop(); }
			    if(field.includes("geber2") == true){ geber2 = pa2003_arr[i].split(":").pop(); }
			    if(field.includes("geber3") == true){ geber3 = pa2003_arr[i].split(":").pop(); }
...
//				this.getView().byId("btnSend").setVisible(false);
			...
			{
				this.byId("changerDate").setVisible(false);
			}
			this.byId("GEBER1").setValue(geber1);
			this.byId("GEBER2").setValue(geber2);
			this.byId("GEBER3").setValue(geber3);
			this.byId("timper1").setValue(timper1);
			this.byId("timper2").setValue(timper2);
			this.byId("timper3").setValue(timper3);
			...
			oRouter.getRoute("TM/approveChangeTurn").attachPatternMatched(this._onObjectMatched, this);
		},
		...
		onAccept: function (){
			...
			if(selapp == "ไม่อนุมัติ" || selvup == "ไม่อนุมัติ" || selapp == "ไม่ยอมรับ" || selvup == "ไม่ยอมรับ" ){
				...
				var pernrpad = perno.toString().padStart(8,'0');
...
//				$.ajax({
//		        	type: "GET",
//		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1001/A/"+pa0001.PA0001.plans,
//		        	async: false,
//		        	success: function(data){
//		        		hrp1001 = data;
//		        		
...
//				
//				var org;
//				for(var oj = 0; oj < hrp1001.List.length ; oj++ ){
//					if(hrp1001.List[oj].sclas == "O"){
//						org = hrp1001.List[oj].sobid;
//					}
//				}
//				
//				$.ajax({
//		        	type: "GET",
//		        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1001/A/"+org,
//		        	async: false,
//		        	success: function(data){
//		        		hrp1001 = data;
//		        		
...
//				var b012;
//				for(var oj = 0; oj < hrp1001.List.length ; oj++ ){
//					if(hrp1001.List[oj].sclas == "S" && hrp1001.List[oj].subty == "B012"){
//						b012 = hrp1001.List[oj].sobid;
//					}
//					if(b012 == undefined){
//						if(hrp1001.List[oj].sclas == "O"){
//							org = hrp1001.List[oj].sobid;
...
//					$.ajax({
//			        	type: "GET",
//			        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1001/P/"+b012,
//			        	async: false,
//			        	success: function(data){
//			        		tmp1001 = data;
//			        		
...
//			        	}
//			        });
//					if(tmp1001 != undefined){
//						
//						$.ajax({
//				        	type: "GET",
//				        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1000/"+tmp1001.HRP1001.sobid,
//				        	async: false,
//				        	success: function(data){
//				        		hrp1000 = data;
//				        		
...
//					
//					for(var oj = 0; oj < hrp1001.List.length ; oj++ ){
//						if(hrp1001.List[oj].sclas == "O" && hrp1001.List[oj].subty == "A002"){
//							objid = hrp1001.List[oj].sobid;
//						}
//					}
//					
//				}
//				
//				if(dataJ.pernr == perno){
//					dataJ.userch = dataJ.pernr;
//					dataJ.pernr = parseInt(tmp1001.HRP1001.sobid).toString();
//				}
//				else if(dataJ.pernr == parseInt(tmp1001.HRP1001.sobid).toString())
//				{
//					
//					var hrp1001;
//					$.ajax({
//			        	type: "GET",
//			        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/HRP1001/A/"+b012,
//			        	async: false,
//			        	success: function(data){
//			        		hrp1001 = data;
//			        		
