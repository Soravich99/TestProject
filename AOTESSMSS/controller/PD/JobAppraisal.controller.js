sap.ui.define([
	...
	"use strict";
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.PD.JobAppraisal", {
		...
		onInit: function () {
			...
			$.ajax({
	        	type: "GET",
	        	url: "http://webdeqapp.airportthai.co.th:8088/api/aot/v1/ZTHRPDE16/"+user+"/"+year,
	        	async: false,
	        	success: function(data){
	        		zthrpde16 = data;
	        	},
			...
			if(zthrpde16 != "X"){
				...
				var status1 = true;
				var status2 = true;
				if(zthrpde16.ZTHRPDE16.status != null){
					bool = false;
				}else{
					bool = true;
				}
				if(bool == false){
					if(zthrpde16.ZTHRPDE16.status == "1"){
						status2 = false;
					}else{
						status1 = false;
					}
				...
				var oItem = new sap.m.ColumnListItem({
					cells : [new sap.m.Text({text : "ประจำปี "+zthrpde16.ZTHRPDE16.zthrpde16key.year}),
							 new sap.m.Text({text : zthrpde16.ZTHRPDE16.grade}),
